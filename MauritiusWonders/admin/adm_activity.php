...
//SQL query to select Sea activities
$sql = "SELECT * FROM activity WHERE activity_type= 1";
//SQL query to select Nature activities
			...
			<?php if($results->num_rows == 0)
{
	die("<h2>No activities available</h2>");
			...
			<?php foreach ($results as $result){ ?><div class="activity-card">
					...
					<p>For More Activities, Visit</p>
						...
						<a href="edit_act.php?id=<?php echo $result['id'] ;?>" class="activity-link">Edit </a>
						<a href="delete.php?id=<?php echo $result['id'] ;?>&from=act" id = "delete" class="activity-link">Delete </a>
				</div>	<?php }?>
			</div>
            <?php }
            else { ?>
            ...
            <?php if($results_0->num_rows == 0)
                  {
	                die("<h2>No activities available</h2>");
            }?>

			<?php foreach ($results_0 as $result_0){ ?><div class="activity-card">
					...
					<p>For More Activities, Visit</p>
						...
						<a href="edit_act.php?id=<?php echo $result_0['id'] ;?>" class="activity-link">Edit </a>
						<a href="delete.php?id=<?php echo $result_0['id'] ;?>&from=act" id = "delete" class="activity-link">Delete </a>
				</div>
				<?php }?>
    ...
    // display all sea activities by default if no type is selected
    else{  ?>
