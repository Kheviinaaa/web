...
<body>
    ...
    <div class="contact-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="img_src" placeholder="Enter hotel's image source">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="star" placeholder="Enter your star ratings">
        </div>

        <div class="form-group">
            <label>Hotel Description</label>
            <input type="text" id="description" placeholder="Enter your hotel's description">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="book" placeholder="Enter your booking URL">
        </div>
...
<script>
    $(document).ready(function() {
        $("button").click(function() {
            ...
            if (img_src == "" || name == "" || picture_src == "" || star == "" || description == "" || visit_web == "" || book == "") {
